...
async def media(bot, message):
    ...
    try:
        ...
        search = re.sub(
        r'\b(480p|720p|1080p|2160p|WEB[- ]DL|WEBRip|HDRi|Seri|Series|HDR|HDRip|HQ|BluRay|AMZN|NF|Hindi|Dual|AAC2 0|AAC|H 265|HEVC|x264|x265|The Punisher)\b','',search,flags=re.IGNORECASE)
